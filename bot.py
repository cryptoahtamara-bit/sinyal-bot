...
def mexc_get_contract_info(symbol):
    ...
    try:
        ...
        if d.get("success"):
            ...
            print(f"[MEXC] Contract fields: fairPrice={data.get('fairPrice')} lastPrice={data.get('lastPrice')} maxLev={lev} volDec={vol_decimals} maxVol={max_vol}")
            if mp > 0:
...
print(f"[BASLANGIC] ========== BOT VERSIYON: v227 ==========")
