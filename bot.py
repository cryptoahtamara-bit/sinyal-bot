...
def mexc_headers(body_dict=None):
    ...
    return {"ApiKey": MEXC_API_KEY, "Request-Time": ts,
            ...
            "Content-Type": "application/json"}, ts
...
def mexc_test():
    ...
    sonuc = {"version": "v179", "proxy": bool(MEXC_PRIVATE_PROXY)}
...
def webkey_test():
    ...
    try:
        ...
        r = requests.get(f"{MEXC_BASE_URL}/api/v1/private/account/assets",
                         headers=hdrs, timeout=10)
        sonuc["get_assets"] = {"status": r.status_code, "body": r.text[:200]}
    except Exception as e:
        sonuc["get_assets"] = {"error": str(e)}
    # WEB-key ile POST testi — bos body ile imza hatasi bekliyoruz, 403 degil
    try:
        hdrs2 = {
            "Content-Type": "application/json",
            "x-mxc-nonce": str(int(time.time() * 1000)),
        ...
        sonuc["post_order"] = {"status": r2.status_code, "body": r2.text[:200]}
    except Exception as e:
        sonuc["post_order"] = {"error": str(e)}
...
print(f"[BASLANGIC] ========== BOT VERSIYON: v179 ==========")
