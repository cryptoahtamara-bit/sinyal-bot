...
def _skor_klines_cek(symbol, interval, limit):
    ...
    1h icin birden fazla interval adi denenir.
    """
        ...
        try:
            ...
            if r.status_code == 200:
                ...
                if data and isinstance(data, list):
                    ...
                    volumes = [float(k[5]) for k in data]
                    if closes:
                        print(f"[SKOR] Binance OK: {symbol} {interval} {len(closes)} mum")
                        return closes, volumes, highs, lows
        except Exception as e:
            print(f"[SKOR] Binance hata ({symbol} {interval} {binance_url}): {e}")
...
def _olta_skor_kontrol(metin):
    ...
    def _blok_kontrol(satirlar, yon):
        ...
        for s in satirlar:
            ...
            tp1 = s["tp1"]; tp2 = s["tp2"]
            etiket = str(giris)  # giris fiyatini etiket olarak goster
            ...
            if not giris_ulasildi:
                ...
                cikti.append("  {} \u23f3".format(etiket))  # Bekleniyor = gelmedi
...
BOT_VERSIYON = "v426"
print(f"[BASLANGIC] ========== BOT VERSIYON: v426 ==========")
