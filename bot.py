        ...
        try:
            ...
            if is_trade:
                ...
                if not is_futures:
                    ...
                    # 1dk ve 3dk sinyalleri islem acilmaz, sadece Telegram bildirimi
                    print(f"[MEXC] {timeframe}dk sinyal — minimum 5dk gerekli, islem atlandı")
                elif tp1_gecildi:
...
print(f"[BASLANGIC] ========== BOT VERSIYON: v223 ==========")
