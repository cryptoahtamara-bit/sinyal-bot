                ...
                def _grid_bolge(grid, alt, ust, price_min, price_max, n_pb, top_n=8):
                    ...
                    for i in range(len(sevs)):
                        for j in range(i+2, len(sevs)+1):
                            ...
                            pct = aralik / kume[0]
                            if pct <= 0.025 and aralik < en_aralik:
                                en_aralik = aralik
                                en_iyi = kume
...
BOT_VERSIYON = "v500"
print(f"[BASLANGIC] ========== BOT VERSIYON: v500 ==========")
