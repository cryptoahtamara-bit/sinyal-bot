...
def _tp_kosul_rapor_gorsel(veri=None, snapshot=None):
    ...
    def gorsel_yap(basliklar_renkler_satirlar_sutunlar, baslik_ana, alt_yazi=""):
        """Tek bir görsel üretir. basliklar_renkler_satirlar_sutunlar = [(baslik,renk,satirlar,sutunlar),...]"""
        SATIR_H = 0.46
        FONT_SATIR = 13
        FONT_SUTUN = 11
        FONT_BASLIK = 13
