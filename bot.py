                        ...
                        try:
                            ...
                            if not sonuc:
                                ...
                                if cache:
                                    ...
                                    if fmt == "tablo":
                                        # Alintilanan mesaj basligindan yon belirle
                                        import re as _re
                                        rt_upper = rt.upper()
                                        if "SHORT" in rt_upper:
                                            # SHORT mesaji alintilandi
                                            sonuc = _olta_skor_kontrol(cache.get("short_msg", ""))
                                        elif "LONG" in rt_upper:
                                            # LONG mesaji alintilandi
                                            sonuc = _olta_skor_kontrol(cache.get("long_msg", ""))
                                        else:
                                            # Her ikisini de gonder
                                            sl = _olta_skor_kontrol(cache.get("long_msg",  ""))
                                            ss = _olta_skor_kontrol(cache.get("short_msg", ""))
                                        ...
                                        # Oncelikle parse edilmis dict varsa kullan
...
BOT_VERSIYON = "v432"
print(f"[BASLANGIC] ========== BOT VERSIYON: v432 ==========")
