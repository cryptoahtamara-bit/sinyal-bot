...
try:
    ...
    HAS_WS = False
# bot_v469 — 7 Haziran 2026
# Degisiklikler (v468 -> v469):
                ...
                if not is_futures:
                    ...
                    if not mevcut and tp1_gecildi:
                        ...
                        if mevcut_long != is_long and _acik_hedge and _acik_hedge.get("is_long") == is_long:
                            ...
                            tp1_revize, fee_notu_2a = tp1_karlilik_kontrol(mp, tp1, tp2, is_long, tp3, tp4, tp5, symbol=symbol)
                            if tp1_revize:
                                tpsl_sonuc = mexc_update_tpsl(symbol, is_long, tp1_revize, sl)
                                tpsl_ok = tpsl_sonuc[0] if isinstance(tpsl_sonuc, tuple) else tpsl_sonuc
                                if tpsl_ok:
                                    with pozisyon_kilit:
                                    ...
                                    mexc_notify(symbol, sinyal,
                                        bilgi_msg=f"🛡️ HEDGE Revize Atlandı\nTP güncellenmedi — TP kârsız yönde (avg={mp})")
                            else:
                                mexc_notify(symbol, sinyal,
...
BOT_VERSIYON = "v447"
print(f"[BASLANGIC] ========== BOT VERSIYON: v469 ==========")
