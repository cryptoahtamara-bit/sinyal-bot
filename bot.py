...
def _ls_gorsel(btc_ls, eth_ls, zaman_str):
    ...
    fig = plt.figure(figsize=(7.42, 10), facecolor=BG)
    fig.patch.set_facecolor(BG)
    ...
    try:
        ...
        for i, sym in enumerate(SEMBOLLER):
            ...
            ax.text(COL["fiyat"], my, fmt_fiyat(veri.get("fiyat")), ha="right", va="center",
                    fontsize=9.375, color=GRAY, fontweight="bold")

            # 24s%
            d24 = veri.get("degisim_24h")
            ax.text(COL["d24"], my, f"{d24:+.1f}%" if d24 is not None else "—",
                    ha="right", va="center", fontsize=9.375, color=renk_pct(d24), fontweight="bold")
            ...
            ax.text(COL["rsi"], my, f"{rsi:.1f}" if rsi else "—",
                    ha="right", va="center", fontsize=9.375, color=r_col, fontweight="bold")

            # Funding
            fund = veri.get("funding", 0)
            ax.text(COL["fund"], my, f"{fund:+.4f}" if fund != 0 else "0",
                    ha="right", va="center", fontsize=8.90625, fontweight="bold",
            ...
            if oi_d:
                ...
                ax.text(COL["oi"], my, f"{dp:+.1f}%", ha="right", va="center",
                        fontsize=9.375, color=renk_pct(dp), fontweight="bold")
            else:
                ax.text(COL["oi"], my, "—", ha="right", va="center", fontsize=9.375, color=GRAY, fontweight="bold")
            ...
            if taker:
                ...
                ax.text(COL["taker"], my, f"{bp:.0f}%B", ha="right", va="center",
                        fontsize=9.375, color=t_col, fontweight="bold")
            else:
                ax.text(COL["taker"], my, "—", ha="right", va="center", fontsize=9.375, color=GRAY, fontweight="bold")
            ...
            if cvd:
                ...
                ax.text(COL["cvd"], my, cvd_str, ha="right", va="center",
                        fontsize=9.375, color=c_col, fontweight="bold")
            else:
                ax.text(COL["cvd"], my, "—", ha="right", va="center", fontsize=9.375, color=GRAY, fontweight="bold")
            ...
            if hc and hc > 0:
                ...
                ax.text(COL["hac"], my, hc_str, ha="right", va="center",
                        fontsize=8.90625, color=hc_col, fontweight="bold")
            else:
                ax.text(COL["hac"], my, "—", ha="right", va="center", fontsize=8.90625, color=DGRAY, fontweight="bold")
        ...
        for pi, sym in enumerate(["BTCUSDT", "ETHUSDT", "SOLUSDT"]):
            ...
            ax.text(px + panel_w/2, y - 0.14,
                    ...
                    ha="center", va="top", fontsize=10.6875, color=WHITE, fontweight="bold")
            ...
            if taker:
                ...
                ax.text(px + panel_w/2, y - 0.32,
                        ...
                        ha="center", va="top", fontsize=7.875, color=t_col)
            ...
            FS_L  = 8.4375   # label font
            FS_V  = 9.5625   # değer font
            LH    = 0.26  # satır yüksekliği

            def satir(label, val1, val2=None, renk=WHITE):
                nonlocal ly
                ax.text(pad_l, ly, label, ha="left", va="top", fontsize=FS_L, color=GRAY)
                vstr = fmt_fiyat(val1)
                if val2 is not None:
            ...
            ax.text(pad_l, ly, "LONG OLTA", ha="left", va="top",
                    fontsize=9.5625, color=GREEN, fontweight="bold")
            ly -= 0.22
            ...
            ax.text(pad_l, ly, "SHORT OLTA", ha="left", va="top",
                    fontsize=9.5625, color=RED, fontweight="bold")
            ly -= 0.22
        ...
        for sym2, col, lbl in legend_items:
            ax.text(lx, y - 0.14, sym2, ha="left", va="top", fontsize=7.5, color=col)
            ax.text(lx + 0.15, y - 0.14, lbl, ha="left", va="top", fontsize=7.5, color=WHITE)
            lx += 1.38
...
BOT_VERSIYON = "v284"
print(f"[BASLANGIC] ========== BOT VERSIYON: v344 ==========")
