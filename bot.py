...
def mexc_test():
    ...
    sonuc = {"version": "v182", "proxy": bool(MEXC_PRIVATE_PROXY)}
...
def webkey_test():
    ...
    # Test 4: Gercek order body ile API key + browser header
    if MEXC_API_KEY and MEXC_API_SECRET:
        try:
            gercek_body = {
                "symbol": "BTC_USDT",
            ...
            hdrs4, _ = mexc_headers(gercek_body)
            r4 = requests.post(f"{MEXC_BASE_URL}/api/v1/private/order/submit",
                               headers=hdrs4, json=gercek_body, timeout=10)
            sonuc["post_real_body"] = {"status": r4.status_code, "body": r4.text[:300]}
        except Exception as e:
            sonuc["post_real_body"] = {"error": str(e)}
...
print(f"[BASLANGIC] ========== BOT VERSIYON: v182 ==========")
