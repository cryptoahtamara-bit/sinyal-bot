...
def _analiz_gonder(chat_id=None):
    ...
    try:
        ...
        try:
            ...
            _puan_g = 0
            if _ort_skor_g >= 75: _puan_g += 2
            elif _ort_skor_g >= 55: _puan_g += 1
            elif _ort_skor_g <= 25: _puan_g -= 2
            elif _ort_skor_g <= 40: _puan_g -= 1
            if _breadth_g >= 8: _puan_g += 2
            elif _breadth_g >= 6: _puan_g += 1
            elif _breadth_g <= 2: _puan_g -= 2
            elif _breadth_g <= 4: _puan_g -= 1
            if _puan_g >= 4:    _piyasa_yonu_g = "Yükseliş"
            elif _puan_g >= 2:  _piyasa_yonu_g = "Yükseliş"
            elif _puan_g <= -4: _piyasa_yonu_g = "Düşüş"
            ...
            print(f"[ANALIZ] _GLOBAL cache guncellendi: fg={_fg_d_g} piyasa={_piyasa_yonu_g} fund={_btc_fund_g}")
        except Exception as _e:
