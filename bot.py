...
try:
    ...
    HAS_WS = False
# bot_v540 — 15 Haziran 2026
# Degisiklikler (v539 -> v540):
#   1. _tp_kosul_rapor_hesapla: 3 yeni kombinasyon dict eklendi
...
#   2. _tp_kosul_yorum_uret: guvenskoru fonksiyonu eklendi
#      - <10 sinyal: ⚠️ düşük veri
#      - 10-29: 🔸 orta güven
#      - 30-59: ✅ güvenilir
#      - 60+: 💎 yüksek güven
#   3. Funding/Piyasa/F&G karşılaştırma satırlarına güven etiketi eklendi
#   4. Yeni dörtlü kombinasyon bölümü (🔷) eklendi
#   5. Yeni OI+Funding+Sinyal tipi bölümü (⚡) eklendi
...
def _tp_kosul_rapor_hesapla(snapshot=None):
    ...
    # 14. Öneri: min 20 sinyal, en yüksek TP oranlı kombinasyonlar
    MIN_SINYAL = 20
    tum_kombinasyonlar = {}
...
def _tp_kosul_yorum_uret(veri):
    ...
    # 9. Piyasa koşulları confluance analizi — güven etiketiyle
...
def _tp_confluance_skoru_hesapla(veri):
    ...
    LONG_KELIMELER  = ["Yükseliş", "Pozitif", "Strong Buy", "Long", "OI Artıyor", "Aşırı Korku", "Korku", "Ortalama Üstü"]
    SHORT_KELIMELER = ["Düşüş", "Negatif", "Strong Sell", "Short", "OI Azalıyor", "Açgözlülük", "Aşırı Açgözlülük", "Ortalama Altı"]
