...
def mexc_place_order(symbol, sinyal, tp1=None, sl=None):
    ...
    # Order oncesi cross margin ve leverage set et
    try:
        lev_body = {"symbol": sym, "leverage": lev, "openType": 1, "positionType": 1}
        r_lev = mexc_private_post(f"{MEXC_BASE_URL}/api/v1/private/position/change_leverage", lev_body)
        print(f"[MEXC] Leverage/cross set: {r_lev.text[:100]}")
    except Exception as e:
        print(f"[MEXC] Leverage set hatasi: {e}")
...
def mexc_update_tpsl(symbol, is_long, tp1, sl):
    ...
    try:
        ...
        r2 = mexc_private_post(f"{MEXC_BASE_URL}/api/v1/private/planorder/tpsl/create", body)
...
BOT_VERSIYON = "v256"
print(f"[BASLANGIC] ========== BOT VERSIYON: v256 ==========")
