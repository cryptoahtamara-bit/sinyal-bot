...
def mexc_place_order(symbol, sinyal, tp1=None, sl=None):
    ...
    if not tp_gecerli:
        print(f"[MEXC] TP1 gecersiz/cok yakin: mp={mp} tp1={tp1_f}")
        return {"success": False, "msg": f"TP1 cok yakin (mp={mp} tp1={tp1_f}), islem atlandı"}
    if not sl_gecerli:
        print(f"[MEXC] SL gecersiz/cok yakin: mp={mp} sl={sl_f}")
        return {"success": False, "msg": f"SL cok yakin (mp={mp} sl={sl_f}), islem atlandı"}
...
print(f"[BASLANGIC] ========== BOT VERSIYON: v222 ==========")
