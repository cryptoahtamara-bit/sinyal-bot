...
def tp_kontrol_gonder(symbol, sinyal, timeframe, tp1, tp2, tp3, tp4, tp5, sl,
    ...
    def bildirim_gonder(msg):
        ...
        # 1) TOPIC_ALARM — sadece botun işlem açtığı sinyaller için
        if mexc_acildi:
                    ...
                    if mevcut:
                        ...
                        if mevcut_long != is_long:
                            ...
                            if tp1_zarar:
                                ...
                                # Küçülme veya iyileşme — her iki durumda da kabul et
...
BOT_VERSIYON = "v393"
print(f"[BASLANGIC] ========== BOT VERSIYON: v393 ==========")
