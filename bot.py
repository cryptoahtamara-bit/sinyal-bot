...
def mexc_private_post(url, body, timeout=15):
    """Private POST — imza bos body, parametreler query string (WAF bypass)"""
    hdrs, ts = mexc_headers(None)  # imza bos string uzerinden
...
def mexc_test():
    ...
    sonuc = {"version": "v198", "proxy": bool(MEXC_PRIVATE_PROXY)}
    ...
    # 4. Imza debug — bos body imzasi + query string gonderim
    if MEXC_API_KEY and MEXC_API_SECRET:
...
print(f"[BASLANGIC] ========== BOT VERSIYON: v198 ==========")
