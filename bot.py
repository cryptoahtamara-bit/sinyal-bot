...
def _olta_fib_hesapla(closes, highs, lows, fiyat, interval):
    ...
    # TP: fiyatin USTUNDEKI fib seviyeleri
    l_tp_adaylar = sorted([f for f in [fib_100, fib_1272, fib_1618] if f > fiyat])
    ...
    # TP: fiyatin ALTINDAKI fib seviyeleri
    s_tp_adaylar = sorted(
        [f for f in [fib_382, fib_236, swing_low] if f < fiyat],
        reverse=True
    )
    ...
    if short_tp1 == short_tp2:
        short_tp2 = rd(short_tp1 * 0.980)
