                        ...
                        try:
                            ...
                            if not sonuc:
                                ...
                                if cache:
                                    ...
                                    if fmt == "tablo":
                                        # Long ve short mesajlari cache'den al
                                        sonuc_long  = _olta_skor_kontrol(cache.get("long_msg",  ""))
                                        sonuc_short = _olta_skor_kontrol(cache.get("short_msg", ""))
                                        if sonuc_long:
                                            _telegram_topic_mesaj_gonder(TOPIC_OLTA, sonuc_long)
                                        if sonuc_short:
                                            time.sleep(0.3)
                                            _telegram_topic_mesaj_gonder(TOPIC_OLTA, sonuc_short)
                                        return
                                    elif fmt == "eski":
...
BOT_VERSIYON = "v430"
print(f"[BASLANGIC] ========== BOT VERSIYON: v430 ==========")
