...
def _tplog_gorsel_uret(kayitlar, tarih_str):
    ...
    try:
        ...
        for k in kayitlar:
            ...
            if not top3:
                ...
                if top5:
                    ...
                    if len(kosul) > 40: kosul = kosul[:38] + "…"
        ...
        # figsize: genişlik sabit 12 (Telegram için dar), yükseklik dinamik
        ...
        XPOS  = [0.005, 0.055, 0.085,              0.72,   0.79,    0.90]
        ...
        for i, (saat, sira, kosul, tp, tp_say, sin_say, yon, ilk_mi) in enumerate(satirlar):
            ...
            if not ilk_mi:
                ax.plot([0.055, 0.99], [y_top, y_top],
            ...
            sira_renk = {SIRA_EMOJI[0]: GREEN, SIRA_EMOJI[1]: TEAL, SIRA_EMOJI[2]: TEXT_G}.get(sira, TEXT_G)
            ...
            renkler  = [TEXT_G, sira_renk, TEXT_W if ilk_mi else TEXT_G,
                        tp_renk, TEXT_G, yon_renk]
            fontlar  = [7.5, 7.5, 7.5 if ilk_mi else 7, 7.5, 7, 7.5]
        ...
        ozet_box  = FancyBboxPatch((0, 0), 1.0, satir_h * 0.85,
                                   boxstyle="square,pad=0",
                                   facecolor=HEADER, edgecolor="none",
                                   transform=ax.transAxes, clip_on=False)
        ax.add_patch(ozet_box)
        ax.text(0.5, satir_h * 0.42, ozet_txt,
