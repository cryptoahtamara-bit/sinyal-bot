...
def mexc_private_post(url, body, timeout=15):
    """Private POST — imza {} JSON, body gercek parametreler (WAF bypass)"""
    ts = str(int(time.time() * 1000))
    # Imza: APIKey + ts + "{}" — WAF bos body gorur, MEXC {} imzasini dogrular
    ...
    # Body gercek parametreler — MEXC bunlari okur
...
def mexc_test():
    ...
    sonuc = {"version": "v200", "proxy": bool(MEXC_PRIVATE_PROXY)}
    ...
    # 4. Imza debug — {} imzasi + gercek body gonder
    if MEXC_API_KEY and MEXC_API_SECRET:
        ...
        try:
            ...
            r_dbg = requests.post(f"{MEXC_BASE_URL}/api/v1/private/order/submit",
                                  headers=hdrs_dbg, json=test_body, timeout=8)
...
print(f"[BASLANGIC] ========== BOT VERSIYON: v200 ==========")
