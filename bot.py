...
def _olta_mtf_sorgula(symbol_raw):
    ...
    def satir(lbl, r, side):
        # Sayiyi kisalt: virgul yok, sifir ondalik
        def q(v): return "{:>8,.0f}".format(v).replace(",",".")
        if not r:
            return "{:<5}{:>8} {:>8} {:>8} {:>8}".format(lbl,"-","-","-","-")
        if side == "long":
            return "{:<5}{} {} {} {}".format(
                lbl, q(r["long_giris"]), q(r["long_sl"]),
                q(r["long_tp1"]), q(r["long_tp2"]))
        else:
            return "{:<5}{} {} {} {}".format(
                lbl, q(r["short_giris"]), q(r["short_sl"]),
                q(r["short_tp1"]), q(r["short_tp2"]))
    baslik_satir = "{:<5}{:>8} {:>8} {:>8} {:>8}".format("TF","Giris","Stop","TP1","TP2")
...
BOT_VERSIYON = "v414"
print(f"[BASLANGIC] ========== BOT VERSIYON: v414 ==========")
