...
def mexc_place_order(symbol, sinyal, tp1=None, sl=None):
    ...
    # Hedge mode: side=1 long ac, side=3 short ac (side=2/4 pozisyon kapatma)
    ...
    # Hedge mode: positionType=1 long, positionType=2 short (openType gonderilmiyor)
    position_type = 1 if is_long else 2
    body = {"symbol": sym, "price": 0, "vol": vol, "side": side, "type": 5, "positionType": position_type}
...
def mexc_pozisyon_kapat(symbol, is_long):
    ...
    try:
        ...
        # Hedge mode: LONG kapat = side=2, SHORT kapat = side=4
        side = 2 if is_long else 4
...
BOT_VERSIYON = "v263"
print(f"[BASLANGIC] ========== BOT VERSIYON: v263 ==========")
