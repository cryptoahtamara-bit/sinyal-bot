...
def _analiz_ozet_telegram(coin_verileri, veriler, zaman_str):
    ...
    try:
        ...
        mevcut_fg_deger   = fg_deger           # sayısal F&G (0-100) — zaten fonksiyonun başında çekildi
        mevcut_breadth_n  = breadth            # EMA üstündeki coin sayısı
...
BOT_VERSIYON = "v447"
print(f"[BASLANGIC] ========== BOT VERSIYON: v447 ==========")
