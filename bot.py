...
def _analiz_gorsel(veriler, zaman_str):
    ...
    try:
        ...
        for cx, lbl, ha in col_defs:
            ax.text(cx, y, lbl, ha=ha, va="top", fontsize=8.5, color=WHITE, fontweight="bold")
        y -= 0.13
        ...
        for i, sym in enumerate(SEMBOLLER):
            ...
            ax.text(COL["coin"], my, sym_kisa, ha="left", va="center",
                    fontsize=10, color=sym_renk, fontweight="bold")
            ...
            ax.text(COL["d24"], my, f"{d24:+.1f}%" if d24 is not None else "—",
                    ha="right", va="center", fontsize=8.5, color=renk_pct(d24))
            ...
            if oi_d:
                ...
                ax.text(COL["oi"], my, f"{dp:+.1f}%", ha="right", va="center",
                        fontsize=8.5, color=renk_pct(dp))
            else:
                ax.text(COL["oi"], my, "—", ha="right", va="center", fontsize=8.5, color=GRAY)
            ...
            if taker:
                ...
                ax.text(COL["taker"], my, "—", ha="right", va="center", fontsize=8.5, color=GRAY)
            ...
            if cvd:
                ...
                ax.text(COL["cvd"], my, cvd_str, ha="right", va="center",
                        fontsize=8.5, color=c_col)
            else:
                ax.text(COL["cvd"], my, "—", ha="right", va="center", fontsize=8.5, color=GRAY)
            ...
            if lik and lik["toplam_usd"] > 0:
                ...
                ax.text(COL["lik"], my, lik_str, ha="right", va="center",
                        fontsize=8, color=l_col)
            else:
                ax.text(COL["lik"], my, "—", ha="right", va="center", fontsize=8, color=DGRAY)
            ...
            if hc and hc > 0:
                ...
                ax.text(COL["hac"], my, hc_str, ha="right", va="center",
                        fontsize=8, color=hc_col)
            else:
                ax.text(COL["hac"], my, "—", ha="right", va="center", fontsize=8, color=DGRAY)
        ...
        for pi, sym in enumerate(["BTCUSDT", "ETHUSDT", "SOLUSDT"]):
            ...
            if taker:
                ...
                ax.text(px + panel_w/2, y - 0.42,
                        ...
                        ha="center", va="top", fontsize=6.5, color=t_col)
        ...
        for sym2, col, lbl in legend_items:
            ax.text(lx, y - 0.12, sym2, ha="left", va="top", fontsize=7, color=col)
            ax.text(lx + 0.14, y - 0.12, lbl, ha="left", va="top", fontsize=6.5, color=WHITE)
            lx += 1.57
        # Sağ legend — 2 satır
        ax.text(fig_w - 0.10, y - 0.08,
                "CVD=Alış/Satış  ·  LİK.M=Likidasyon  ·  HAC.Ç=Fut/Spot  ·  UYM⚠=Uyumsuz",
