...
def _olta_skor_kontrol(metin):
    ...
    def _blok_kontrol(satirlar, yon, since_ts=None):
        ...
        if since_ts:
            ...
            limit_map = {
                "5m":  min(int(gecen_sn/300)+2,  500),
                "15m": min(int(gecen_sn/900)+2,  200),
                "1h":  min(int(gecen_sn/3600)+2, 100),
                "4h":  min(int(gecen_sn/14400)+2, 60),
                "1d":  min(int(gecen_sn/86400)+2, 30),
            }
        else:
            limit_map = {"5m": 288, "15m": 96, "1h": 72, "4h": 52, "1d": 52}
        for s in satirlar:
...
BOT_VERSIYON = "v436"
print(f"[BASLANGIC] ========== BOT VERSIYON: v436 ==========")
