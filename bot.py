...
def koin_sirala_bugun(snapshot=None):
    ...
    for s in kayitlar:
        ...
        if tf not in TF_GECERLI:
            continue
        # istatistik_sayildi=True olan sinyaller dahil (trade kapalı olsa bile sayılır)
        # Eski kayıtlar için geriye dönük uyumluluk: mexc_acildi=True olanlar da sayılır
        if not s.get("istatistik_sayildi") and not s.get("mexc_acildi"):
            continue
...
BOT_VERSIYON = "v374"
print(f"[BASLANGIC] ========== BOT VERSIYON: v374 ==========")
