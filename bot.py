...
def mexc_update_tpsl(symbol, is_long, tp1, sl):
    ...
    try:
        ...
        # Endpoint 1: plan/place-tp-sl
        r2 = mexc_private_post(f"{MEXC_BASE_URL}/api/v1/private/plan/place-tp-sl", body)
        print(f"[MEXC TPSL] place-tp-sl yanit: {r2.text[:200]}")
        if not r2.json().get("success"):
            # Endpoint 2: order/modify-tpsl
            r2 = mexc_private_post(f"{MEXC_BASE_URL}/api/v1/private/order/modify-tpsl", body)
            print(f"[MEXC TPSL] modify-tpsl yanit: {r2.text[:200]}")
...
BOT_VERSIYON = "v270"
print(f"[BASLANGIC] ========== BOT VERSIYON: v271 ==========")
