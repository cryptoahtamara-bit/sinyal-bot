...
def _olta_mtf_sorgula(symbol_raw):
    ...
    def satir(lbl, r, side):
        if not r:
            return "{:<5} {:<10} {:<10} {:<10} {:<10}".format(lbl, "-", "-", "-", "-")
        if side == "long":
            return "{:<5} {:<10} {:<10} {:<10} {:<10}".format(
                lbl, p(r["long_giris"]), p(r["long_sl"]),
                p(r["long_tp1"]), p(r["long_tp2"]))
        else:
            return "{:<5} {:<10} {:<10} {:<10} {:<10}".format(
                lbl, p(r["short_giris"]), p(r["short_sl"]),
                p(r["short_tp1"]), p(r["short_tp2"]))
    baslik_satir = "{:<5} {:<10} {:<10} {:<10} {:<10}".format("TF", "Giris", "Stop", "TP1", "TP2")
    ayrac = "-" * len(baslik_satir)
