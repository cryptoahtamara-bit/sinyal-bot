...
def mexc_private_post(url, body, timeout=15):
    """Private POST — json={} + params=body ile WAF bypass"""
    hdrs, ts = mexc_headers(body)
    r = requests.post(url, headers=hdrs, json={}, params=body, timeout=timeout)
...
def mexc_test():
    ...
    sonuc = {"version": "v194", "proxy": bool(MEXC_PRIVATE_PROXY)}
...
print(f"[BASLANGIC] ========== BOT VERSIYON: v194 ==========")
