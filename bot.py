...
def _analiz_ozet_telegram(coin_verileri, veriler, zaman_str):
    ...
    try:
        ...
        # CVD sınıflandırma — değer + yön birlikte değerlendiriliyor
        ...
        for sym, v in coin_verileri.items():
            ...
            if uyum == "uyumsuz_asagi" and cvd_val > 0:
                uyumsuz_asagi.append(kisa)           # fiyat ↓ CVD ↑ → birikim
            elif uyum == "uyumsuz_yukari" and cvd_val < 0:
                uyumsuz_yukari.append(kisa)          # fiyat ↑ CVD ↓ → sahte pump
            elif uyum in ("uyum", "duz") and cvd_val < -500:
                uyumlu_asagi.append(kisa)            # fiyat ↓ CVD ↓ → gerçek satış
...
BOT_VERSIYON = "v490"
print(f"[BASLANGIC] ========== BOT VERSIYON: v490 ==========")
