    ...
    if tp1:
        try:
            ...
            if tp_gecerli:
                ...
                print(f"[MEXC] TP1 gecersiz: is_long={is_long} mp={mp} tp1={tp1_f}")
        except Exception as e:
    ...
    if sl:
        try:
            ...
            if sl_gecerli:
                ...
                print(f"[MEXC] SL gecersiz: is_long={is_long} mp={mp} sl={sl_f}")
        except Exception as e:
...
def mexc_test():
    ...
    sonuc = {"version": "v216", "proxy": bool(MEXC_PRIVATE_PROXY)}
...
print(f"[BASLANGIC] ========== BOT VERSIYON: v216 ==========")
