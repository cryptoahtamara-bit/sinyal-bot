...
# IPRoyal Residential Proxy — SADECE private MEXC API istekleri icin
# Public endpoint'ler (mark price, ticker, contract detail) direkt gidiyor
...
def mexc_test():
    ...
    sonuc = {"version": "v173", "proxy": bool(MEXC_PRIVATE_PROXY)}
