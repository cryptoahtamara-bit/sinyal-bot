...
def mexc_get_contract_info(symbol):
    ...
    try:
        ...
        if d.get("success"):
            data = d["data"]
            # fairPrice, lastPrice veya indexPrice dene
            mp = float(data.get("fairPrice") or data.get("lastPrice") or data.get("indexPrice") or 0)
...
def mexc_test():
    ...
    sonuc = {"version": "v206", "proxy": bool(MEXC_PRIVATE_PROXY)}
...
print(f"[BASLANGIC] ========== BOT VERSIYON: v206 ==========")
