...
MEXC_BASE_URL_ALT  = "https://futures.mexc.com"  # Alternatif domain — WAF bypass icin
...
def mexc_test():
    ...
    sonuc = {"version": "v177", "proxy": bool(MEXC_PRIVATE_PROXY)}
...
print(f"[BASLANGIC] ========== BOT VERSIYON: v177 ==========")
